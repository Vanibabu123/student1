...
function Student() {
  ...
  useEffect(() => {
    async function fetchData() {
      let users = await axios.get(
        "https://61f4ac6310f0f7001768c99b.mockapi.io/Students"
      );
      setUsers(users.data);
    }
    fetchData();
  ...
  const deleteUser = (id) => {
    swal({
      ...
      if (willDelete) {
        axios
          .delete(`https://61f4ac6310f0f7001768c99b.mockapi.io/Students/${id}`)
          .then(() => {
            getData();
          });
  ...
  const getData = () => {
    axios
      .get(`https://61f4ac6310f0f7001768c99b.mockapi.io/Students`)
      .then((getData) => {
