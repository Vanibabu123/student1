...
function Teacher() {
  ...
  useEffect(() => {
    async function fetchData() {
      let user = await axios.get(
        "https://61f4ac6310f0f7001768c99b.mockapi.io/Teachers"
      );
      setUsers(user.data);
    }
    fetchData();
  ...
  const deleteUser = (id) => {
        ...
        swal({
          ...
          if (willDelete) {
            axios
      .delete(`https://61f4ac6310f0f7001768c99b.mockapi.io/Teachers/${id}`)
      .then(() => {
        getData();
      });
  ...
  const getData = () => {
    axios
      .get(`https://61f4ac6310f0f7001768c99b.mockapi.io/Teachers/`)
      .then((getData) => {
